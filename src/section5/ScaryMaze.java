...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	if(code==mouseColor) {
		scare();
		JOptionPane.showMessageDialog(null, "Congratulations, you beat the Amazing Maze");
	}
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("139059__justinvoke__scary-hi-hat.wav"));
	...
	showScaryImage("avengers-endgame-poster.jpg");
	}
